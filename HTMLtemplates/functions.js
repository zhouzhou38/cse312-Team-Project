...
function sendMessage() {
    let friendName = document.getElementById("sendTo").innerHTML
    console.log("friendname:","textarea_"+friendName)
    const chatBox = document.getElementById("textarea_"+friendName);
    ...
    chatBox.focus();
    if (comment !== "") {
        let receiver = document.getElementById("sendTo").innerHTML
...
function displayChatHistory(all_chats) {
    ...
    for (const [key, value] of Object.entries(all_chats)) {
        ...
        console.log("foo:",foo)
        console.log("name:","chatBox_"+friendName)
        console.log("tem:",chat_temp)
        if (foo != null){
        ...
        case 'online-user':
            ...
            for(let i=0;i<list.length;i++){
                ...
                if(friendname !== me && document.getElementById("friend_"+friendname)==null){
                    ...
                    // <span id='${"'badge_"+friendname+"'"}' class="badge"></span></button><br>"
                    //`
                    ...
                    // temp += friendname+"\").style.display=\"block\";"
                    // temp += " \' style=\"width: max-content;\" class=\"button\" value=\""
                    // temp += friendname+"\">"
